        ...
        <div class="container">
                    ...
                    <div class="colxl-12 col-lg-12 col-md-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item text-muted"><a href="#">Responsable département fluides</a>
                                </li>
            ...
            <form class="row" action="{{ route('recrutement.postuler') }}" method="post">
                ...
                <div class="dashboard-widg-bar d-block">
                            ...
                            <div class="_dashboard_content bg-white rounded mb-4">
                                <div class="_dashboard_content_header br-bottom py-3 px-3">
                                    <div class="_dashboard__header_flex">
                                        <h4 class="mb-0 ft-medium fs-md"><i class="fa fa-file mr-1 theme-cl fs-sm"></i>Créer
                                            un CV</h4>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control rounded"
                                                           placeholder="Ex : Web Designer" name="titre_pro">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control rounded"
                                                           placeholder="Ex@ex.com" name="email">
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control rounded"
                                                           placeholder="+216 33 333 333" name="tel">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control rounded"
                                                           placeholder="Ex : Ariana,Tunisie" name="adresse">
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control with-light"
                                                              placeholder="Présentez-vous" name="profil"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="_dashboard_content_header br-bottom py-3 px-3">
                                    <div class="_dashboard__header_flex">
                                        <h4 class="mb-0 ft-medium fs-md"><i
                                                class="fas fa-graduation-cap mr-1 theme-cl fs-sm"></i>Formation
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <div class="_dashboard_content_body py-3 px-3">
                                    <div class="col-xl-12 col-lg-12 fvrduplicate2">
                                        <div class="gray rounded p-3 mb-3 position-relative entry2">
                                            <button type="button" class="aps-clone btn-remove2"><i
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control rounded"
                                                               placeholder="dd-mm-yyyy" name="date_deb[]">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control rounded"
                                                               placeholder="dd-mm-yyyy" name="date _fin[]">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    <button type="button"
                                                            class="btn gray ft-medium apply-btn fs-sm rounded btn-add2">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="_dashboard_content bg-white rounded mb-4">
                                <div class="_dashboard_content_header br-bottom py-3 px-3">
                                    <div class="_dashboard__header_flex">
                                        <h4 class="mb-0 ft-medium fs-md"><i
                                                class="fas fa-graduation-cap mr-1 theme-cl fs-sm"></i>Expérience</h4>
                                    </div>
                                </div>
                                ...
                                <div class="_dashboard_content_body py-3 px-3">
                                    <div class="col-xl-12 col-lg-12 fvrduplicate1">
                                        <div class="gray rounded p-3 mb-3 position-relative entry1">
                                            <button type="button" class="aps-clone btn-remove1"><i
                                                    class="fas fa-times"></i></button>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control rounded"
                                                       placeholder="Ex : Tunis,Tunisie" name="emplacement[]">
                                            </div>
                                            <div class="form-row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label class="text-dark ft-medium">Date de début</label>
                                                        <input type="date" class="form-control rounded"
                                                               placeholder="dd-mm-yyyy" name="date_debExp[]">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label class="text-dark ft-medium">Date de fin</label>
                                                        <input type="date" class="form-control rounded"
                                                               placeholder="dd-mm-yyyy" name="date_finExp[]">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="text-dark ft-medium">Tâches effectuées</label>
                                                <textarea class="form-control ht-80" placeholder="Tâches effectuées"
                                                          name="taches[]"></textarea>
                                            </div>
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    <button type="button"
                                                            class="btn gray ft-medium apply-btn fs-sm rounded btn-add1">
                                                        <i class="fas fa-plus mr-1"></i>Ajouter une expérience
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="_dashboard_content bg-white rounded mb-4">
                                <div class="_dashboard_content_header br-bottom py-3 px-3">
                                    <div class="_dashboard__header_flex">
                                        <h4 class="mb-0 ft-medium fs-md"><i
                                                class="fas fa-graduation-cap mr-1 theme-cl fs-sm"></i>Certification</h4>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 fvrduplicate1">
                                        <div class="gray rounded p-3 mb-3 position-relative entry1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control rounded"
                                                       placeholder="Organisme émetteur" name="organisme[]">
                                            </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="_dashboard_content bg-white rounded mb-4">
                                <div class="_dashboard_content_header br-bottom py-3 px-3">
                                    <div class="_dashboard__header_flex">
                                        <h4 class="mb-0 ft-medium fs-md"><i
                                                class="fas fa-graduation-cap mr-1 theme-cl fs-sm"></i>Compétences</h4>
                                    </div>
                                </div>
                                ...
                                <div class="_dashboard_content_body py-3 px-3 repeater-default">
                                    <div class="col-xl-12 col-lg-12 fvrduplicate">
                                        <div class="gray rounded p-3 mb-3 position-relative entry">
                                            <button class="aps-clone btn-remove" type="button"><i
                                                    class="fas fa-times"></i></button>
                                            <div class="form-group">
                                                <label class="text-dark ft-medium">Nom de compétence</label>
                                                <input type="text" class="form-control rounded"
                                                       placeholder="Nom de compétence" name="competence[]">
                                            </div>
                                            <div class="col-xl-12 col-lg-12">
                                                <div class="form-group">
                                                    <button type="button"
                                                            class="btn gray ft-medium apply-btn fs-sm rounded btn-add">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <button type="submit" class="btn btn-md ft-medium text-light rounded theme-bg">Valider
                            </button>
                        </div>
                    </div>
                </div>
