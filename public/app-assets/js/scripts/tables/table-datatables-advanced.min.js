...
function filterColumn(t, a) {
  if (5 == t) {
    ...
    "" !== e && "" !== l && filterByDate(t, e, l),
      $(".dt-advanced-Rechercher").dataTable().fnDraw();
  } else
    $(".dt-advanced-Rechercher")
      .DataTable()
      .column(t)
      .Rechercher(a, !1, !0)
      .draw();
...
$(function () {
  ...
  var t = $(".datatables-ajax"),
    a = $(".dt-column-Rechercher"),
    e = $(".dt-advanced-Rechercher"),
    l = $(".dt-responsive"),
    n = "../../../app-assets/";
  if (
  ...
  if (a.length) {
    $(".dt-column-Rechercher thead tr")
      .clone(!0)
      .appendTo(".dt-column-Rechercher thead"),
      $(".dt-column-Rechercher thead tr:eq(1) th").each(function (t) {
        var a = $(this).text();
        $(this).html(
          ...
          $("input", this).on("keyup change", function () {
            o.column(t).Rechercher() !== this.value &&
              o.column(t).Rechercher(this.value).draw();
          });
      });
    var o = a.DataTable({
